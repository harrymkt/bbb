...
// Define pages array
var pages = [
{ name: "Home", url: "/bbb", accesskey: "h" },
{ name: "Documentation", url: "/bbb/docs", accesskey: "d" },
{ name: "Download", url: "/bbb/download", accesskey: "" }
];
...
dt += "good morning "+get_storage("visitname","visiter")+", thanks for visiting to our website!";
else if(d >= 11 && d < 16)
dt += "good afternoon "+get_storage("visitname","visiter")+", thank you for visiting to our website!";
else
